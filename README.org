* About
  ...
  The two simulation programs, netSim1 and netSim2, correspond to different starting values. netSim1 starts with one node 0, with a self loop, 0 -> 0. netSim2 starts with two node 0 and 1, and a connecting edge 0 -> 1.
